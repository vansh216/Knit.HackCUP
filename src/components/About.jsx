...
const About = () => {
    ...
    return (
        <div id='about' className=' relative overflow-hidden h-screen px-4 md:px-8 lg:px-12 py-6 md:py-8' ref={sectionRef}>
            <div className="relative z-10 w-full h-full flex flex-col">
                <div className="flex items-center justify-center py-4 md:py-6 animate-on-scroll">
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-linear-to-r from-slate-400 to-slate-700 bg-clip-text text-transparent" style={{ fontFamily: 'nexa, sans-serif' }}>
                        ABOUT
                    </h2>
                </div>
                    ...
                    <div className="w-full max-w-7xl grid lg:grid-cols-[58%_42%] items-center gap-6 md:gap-8">
                        ...
                        <div className="space-y-4 md:space-y-6 animate-on-scroll animation-delay-200 px-4 md:px-8 lg:px-12 py-4 md:py-6 bg-transparent flex flex-col justify-center">
                            <div className="space-y-4 md:space-y-6">
                                <p className="text-gray-50  text-base font-semibold md:text-lg leading-relaxed tracking-wide " style={{ wordSpacing: '0.1em', letterSpacing: '0.02em' }}>
                                    <span className="text-[#7CFF4D] font-semibold">Google Developer Group KNIT Sultanpur</span> presents{' '}
                                    <span className="text-[#7CFF4D] font-bold"> Hacker Cup Hackathon</span> on Mar 17, 2026.
                                    This flagship event brings together passionate developers, creative thinkers, and innovative teams from across the region.
                                </p>

                                <p className="text-gray-50   font-semibold  text-base md:text-lg leading-relaxed tracking-wide " style={{ wordSpacing: '0.1em', letterSpacing: '0.02em' }}>
                                    <span className="text-[#7CFF4D] font-bold">Gear up your tech stack</span>, brainstorm bold ideas, unite as a team, and build
                                    solutions that matter at{' '}
                                    <span className="text-[#7CFF4D] font-bold">Purvanchal Technical Hackathon</span> - the signature hackathon experience at KNIT Sultanpur!
                                </p>
                            </div>
