...
const Navbar = () => {
    ...
    return (
        <div className="w-full sticky top-0 z-50  bg-gray-600 shadow-md">
      <div className="flex justify-between items-center h-16 px-6 md:px-18">
        ...
        <div className="logo flex items-center gap-1">
          ...
          <h1 className="text-2xl md:text-3xl font-semibold text-slate-400">
           GDG
            <span className="text-slate-950 font-semibold font-serif">
               Hacker CUP
            </span>
          </h1>
        </div>
